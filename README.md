...
— **Eric Yocam, Hard Science Fiction *The Convergence Chronicles: Cyber Inference (2025)***
...
* **Human Resonance:** Biological tissue creates chaotic, non-linear oscillators. This results in a "bottom-heavy" energy distribution (High Skew) and unique subharmonic signatures.
* **AI Lattice:** Neural vocoders rely on frame-based parametric synthesis. This creates a mathematically "even" or "clean" distribution (Low Skew) that lacks the stochastic "micro-jitter" of a living throat.
...
Inspired by Cy's "Delphi" ethical framework, this scan identifies the biological "weight" of a voice using Higher-Order Statistics (HOS).

* **Authenticity Verified:** A Resonance Lead (Skew) above a 0.4 threshold indicates human anatomy.
* **Spoof Detected:** A flat or low skew reveals the "Digital Tilt" of a synthesized voice.

### 2. Phase-Space Reconstruction (Poincaré Plots)

Cy uses this to visualize the "Forensic Knot" by plotting signal samples against their own delays ( vs ).

* **Organic Knot:** A chaotic, textured cloud of data points (Strange Attractor) representing human entropy and nonlinear phenomena.
* **The Lattice:** Geometric patterns or "tracks" indicating the periodic, frame-by-frame calculation of an AI model.

### 3. Energy Flux Acceleration (NLP Analysis)

Measures the "acceleration" of vocal energy. In the book, Cy looks for the "micro-jitter" and **biphonation** that occurs when a human throat changes phonemes—a biological friction that AI "smooths out" to sound more pleasant.
...
* **Vocal Chaos Theory:** Herzel, H., et al. "Nonlinear dynamics of the voice." *Chaos*, 1995. DOI: [10.1063/1.166078](https://www.google.com/search?q=https://doi.org/10.1063/1.166078)
* **NLP Analysis:** Anikin, A., & Herbst, C. T. "How to analyse and manipulate nonlinear phenomena in voice recordings." *Philosophical Transactions of the Royal Society B*, 2025. DOI: [10.1098/rstb.2024.0003](https://www.google.com/search?q=https://doi.org/10.1098/rstb.2024.0003)
